...
/**
 * struct CaractereSpeciale - structure pour associer un caractere special à une fonction
 * @lettreachanger: le caractere special (ex. 'c', 's', '%', etc.)
 * @pointeurdefonction: un pointeur vers la fonction qui gere ce caractere special
 */
